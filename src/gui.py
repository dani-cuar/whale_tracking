...
save_button_whale_a = tk.Button(outer_frame, text="Save Whale A", font=("Arial", 12), bg="#5bc0ff", fg="white")
...
save_button_whale_a = tk.Button(outer_frame, text="Save Whale B", font=("Arial", 12), bg="#5bc0ff", fg="white")
save_button_whale_a.place(x=1024, y=235, width=105, height=20)

###---------------------------------------SECCIÓN 3 - ÚLTIMOS REGISTROS-----------------------------------###
# "Base de datos" falsa solo para visualizar
fake_db = [
    {
        "ID": "A", "Init Pos": "-33.22", "Final Pos": "24.222", "Time": "1:24:35",
        "# Sightings": "4", "Behavior": "t - traveling", "# Blows": "5", "First Blow": "Y",
        "# Whales": "2", "Individual (letter)": "A", "Initial Distance": "150",
        "# Photos": "8", "Fluke": "Y", "# Skin Sample": "N",
        "Feces in Trail": "N", "# Boats": "3", "Boat Speed": "8",
        "WW-Whale Distance": "120", "Engine On": "Y",
        "Visibility": "Good", "Hydrophone": "N", "Observations": "Calm behavior"
    },
    {
        "ID": "B", "Init Pos": "-33.28", "Final Pos": "24.198", "Time": "1:30:12",
        "# Sightings": "3", "Behavior": "r - resting", "# Blows": "4", "First Blow": "N",
        "# Whales": "1", "Individual (letter)": "B", "Initial Distance": "220",
        "# Photos": "11", "Fluke": "N", "# Skin Sample": "N",
        "Feces in Trail": "Y", "# Boats": "2", "Boat Speed": "6",
        "WW-Whale Distance": "200", "Engine On": "N",
        "Visibility": "Medium", "Hydrophone": "Y", "Observations": "Slow movement"
    }
]
...
def load_last_6_records():
    """Limpia la tabla y carga solo los últimos 5 registros de fake_db."""
    # 1. Limpiar la tabla
    for item in tree.get_children():
        tree.delete(item)

    # 2. Tomar los 7 registros más recientes
    last_6 = fake_db[:6]   # fake_db[0] es el más reciente
...
def add_new_record_to_table(record_dict):
    """Agrega un nuevo registro a fake_db y refresca la vista (solo últimos 5)."""
    fake_db.insert(0, record_dict)  # inserta al inicio (más reciente)
    load_last_6_records()


def simulate_new_record():
    """Simula un nuevo registro para probar visualmente."""
    new_record = {
        "ID": "A",
        "Init Pos": "0",
        "Final Pos": "0",
        "Time": "0",
        "# Sightings": "0",
        "Behavior": "sf - surface feeding",
        "# Blows": "7",
        "First Blow": "Y",
        "# Whales": "3",
        "Individual (letter)": "C",
        "Initial Distance": "180",
        "# Photos": "12",
        "Fluke": "Y",
        "# Skin Sample": "Y",
        "Feces in Trail": "N",
        "# Boats": "4",
        "Boat Speed": "9",
        "WW-Whale Distance": "140",
        "Engine On": "Y",
        "Visibility": "Excellent",
        "Hydrophone": "Y",
        "Observations": "Active social behavior"
    }
    add_new_record_to_table(new_record)
...
# Mostrar solo los últimos 5 al iniciar
load_last_6_records()

# Mapeo columna -> nombre (para actualizar fake_db también)
...
def edit_cell(event):
    ...
    def save_edit(event=None):
        ...
        # Actualizar también la "fake_db" en memoria
        row_index = tree.index(row_id)
        fake_db[row_index][field_name] = new_value
...
# Botón solo para probar visualmente
test_button = tk.Button(
    outer_frame,
    text="Simulate new record",
    command=simulate_new_record
)
test_button.place(x=950, y=370, width=180, height=25)
